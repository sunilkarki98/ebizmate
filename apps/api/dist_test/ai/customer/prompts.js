...
exports.INGESTION_PROMPT = void 0;
exports.CUSTOMER_SYSTEM_PROMPT = CUSTOMER_SYSTEM_PROMPT;
const INGESTION_PROMPT = (contentToAnalyze) => `
...
`;
exports.INGESTION_PROMPT = INGESTION_PROMPT;
function CUSTOMER_SYSTEM_PROMPT(workspace, contextHeader, itemsContext, isSimulation = false) {
    // If a custom template is defined in settings, use it (with variable substitution)
    if (workspace.settings && workspace.settings.systemPromptTemplate) {
        let template = workspace.settings.systemPromptTemplate;
