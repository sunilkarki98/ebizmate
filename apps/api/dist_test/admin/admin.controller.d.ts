...
export declare class AdminController {
    ...
    updateUserRole(req: any, userId: string, role: 'admin' | 'user'): Promise<{
        success: boolean;
    }>;
    ...
    toggleGlobalAiAccess(req: any, workspaceId: string, allowed: boolean): Promise<{
        success: boolean;
    }>;
    updateWorkspacePlan(req: any, workspaceId: string, data: any): Promise<{
        success: boolean;
    }>;
    ...
    resolveEscalation(req: any, interactionId: string): Promise<{
        success: boolean;
    }>;
    getWebhooks(): Promise<{
        id: string;
    ...
    updateAISettings(req: any, body: any): Promise<{
        success: boolean;
    }>;
