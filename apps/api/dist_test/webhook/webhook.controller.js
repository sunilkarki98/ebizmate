...
let WebhookController = class WebhookController {
    ...
    async handleInternalWebhook(platform, rawPayload) {
        // Validate payload using Zod schema
        const parsed = validation_1.webhookBodySchema.safeParse(rawPayload);
        if (!parsed.success) {
...
], WebhookController.prototype, "handleInternalWebhook", null);
exports.WebhookController = WebhookController = __decorate([
    (0, common_1.Controller)('webhook/internal'),
