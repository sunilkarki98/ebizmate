...
import { toggleCustomerPauseAction } from "@/lib/actions";
...
export function CustomerRow({ customer, platform }: CustomerProps) {
    ...
    const handleToggle = () => {
        startTransition(async () => {
            // @ts-ignore - Argument type mismatch in server action but logic is correct
            await toggleCustomerPauseAction(customer.id, !customer.aiPaused);
        });
    };
