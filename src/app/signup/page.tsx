...
function SignUpContent() {
    ...
    async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
        ...
        if (result.error) {
            ...
            setSuccess(true);
            setLoading(false);
            // Optional: Redirect to sign in after short delay
            setTimeout(() => {
    ...
    if (success) {
        return (
            <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background via-background to-muted/30 p-4">
                <Card className="w-full max-w-md shadow-2xl border-emerald-200 bg-emerald-50/50">
            ...
            <Card className="w-full max-w-md relative z-10 shadow-2xl border-border/50">
                <CardHeader className="text-center space-y-4 pb-2">
                    ...
                    <div>
                        ...
                        <CardDescription>Get started with your AI automation bot</CardDescription>
                    </div>
                </CardHeader>
                <CardContent className="space-y-5 pt-4">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <Input id="password" name="password" type="password" placeholder="Min 8 characters" required minLength={8} className="h-11" />
                        </div>
