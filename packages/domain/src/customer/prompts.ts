...
5. If you CANNOT answer based on the context, or if the user asks for a human, write a polite holding message telling the user you need to check with the team and will get back to them soon. Match the Tone.
`;
}
